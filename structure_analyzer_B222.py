...
B_222_dopant_neighbour_Pb_I = [[64,68,76,78,84,85],[66,70,72,74,82,83],[65,69,73,75,80,81]]
...
for i in comb4:
    for j in connec.get_connections():
        if list_a_is_in_list_b(i,j):
            #print(j)
            neighbour4.append(j)
#print("len(neighbour4):",neighbour4)
# To eliminate the redundant pairs
...
distance_adjacent_b = [ ]
distance_adjacent_c = [ ]
a2  = list(range(0,len(neighbour4),6)) + list(range(1,len(neighbour4),6))
b2  = list(range(2,len(neighbour4),6)) + list(range(3,len(neighbour4),6))
c2  = list(range(4,len(neighbour4),6)) + list(range(5,len(neighbour4),6))
for i in a2:
